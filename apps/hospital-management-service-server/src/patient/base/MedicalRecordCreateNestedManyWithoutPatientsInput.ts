...
@InputType()
class MedicalRecordCreateNestedManyWithoutPatientsInput {
...
export { MedicalRecordCreateNestedManyWithoutPatientsInput as MedicalRecordCreateNestedManyWithoutPatientsInput };
